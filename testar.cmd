...
if "%FALHOU%"=="1" (
  ...
  echo RESULTADO: passou, COM PULOS. Alguma bateria nao rodou por falta de estado
  echo             por checkout ^(arquivo gitignorado^). Role para cima: a linha PULADA
  echo             diz qual arquivo e qual comando o cria. Verde aqui seria mentira.
) else (
